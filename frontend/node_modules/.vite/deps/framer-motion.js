...
function scrapeMotionValuesFromProps3(props, prevProps, visualElement) {
  ...
  const newValues = {};
  for (const key in style2) {
    if (isMotionValue2(style2[key]) || prevProps.style && isMotionValue2(prevProps.style[key]) || isForcedMotionValue2(key, props) || ((_a = visualElement == null ? void 0 : visualElement.getValue(key)) == null ? void 0 : _a.liveStyle) !== void 0) {
      newValues[key] = style2[key];
    }
  }
  return newValues;
  ...
  return class ProjectionNode {
    ...
    getProjectionStyles(styleProp) {
      ...
      if (this.needsReset) {
        this.needsReset = false;
        styles.opacity = "";
        styles.pointerEvents = resolveMotionValue2(styleProp == null ? void 0 : styleProp.pointerEvents) || "";
      ...
      if (!this.projectionDelta || !this.layout || !lead.target) {
        ...
        if (this.options.layoutId) {
          ...
          emptyStyles.pointerEvents = resolveMotionValue2(styleProp == null ? void 0 : styleProp.pointerEvents) || "";
        }
      ...
      if (this.options.layoutId) {
        styles.pointerEvents = lead === this ? resolveMotionValue2(styleProp == null ? void 0 : styleProp.pointerEvents) || "" : "none";
      }
      return styles;
    }
    clearSnapshot() {
...
function resolveEdge(edge, length, inset = 0) {
  ...
  if (typeof edge === "string") {
    const asNumber5 = parseFloat(edge);
    if (edge.endsWith("px")) {
      delta = asNumber5;
    } else if (edge.endsWith("%")) {
      edge = asNumber5 / 100;
    } else if (edge.endsWith("vw")) {
      delta = asNumber5 / 100 * document.documentElement.clientWidth;
    } else if (edge.endsWith("vh")) {
      delta = asNumber5 / 100 * document.documentElement.clientHeight;
    } else {
      edge = asNumber5;
    }
  }
...
function useSpring(source, config = {}) {
  ...
  const startAnimation = () => {
    ...
    activeSpringAnimation.current = new JSAnimation({
      keyframes: [asNumber4(value.get()), asNumber4(latestValue.current)],
      velocity: value.getVelocity(),
      type: "spring",
      restDelta: 1e-3,
      restSpeed: 0.01,
...
function createDOMVisualElement(element) {
  ...
  const node = isSVGElement2(element) ? new SVGVisualElement2(options) : new HTMLVisualElement2(options);
  node.mount(element);
